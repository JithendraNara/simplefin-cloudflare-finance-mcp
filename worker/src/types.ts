export interface Env {
  ...
  GATEWAY_TOTAL_PER_5HOURS?: string;
  GATEWAY_LIMIT_GENERATE_WEEKLY_MONEY_BRIEFING?: string;
  GATEWAY_LIMIT_FIND_UNUSUAL_TRANSACTIONS?: string;
  GATEWAY_LIMIT_QUERY_FINANCE?: string;
  GATEWAY_LIMIT_RECATEGORIZE_LOW_CONFIDENCE?: string;
  GATEWAY_LIMIT_GENERATE_CORRECTION_RULE_TEXT?: string;
  GATEWAY_LIMIT_REVIEW_UNCATEGORIZED_SUGGESTIONS?: string;
  ENABLE_GATEWAY_CATEGORIZER_FALLBACK?: string;
